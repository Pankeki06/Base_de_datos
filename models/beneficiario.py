...
class Beneficiario(SQLModel, table=True):
    ...
    id_poliza: int | None = SqlModelField(default=None, foreign_key="poliza.id_poliza", index=True)
    id_beneficio: int | None = SqlModelField(default=None, foreign_key="beneficio.id_beneficio", index=True)
