...
CREATE TABLE IF NOT EXISTS agente (
    id_agente CHAR(36) NOT NULL PRIMARY KEY,
...
CREATE TABLE IF NOT EXISTS asegurado (
    id_asegurado CHAR(36) NOT NULL PRIMARY KEY,
    nombre VARCHAR(100) NOT NULL,
    apellido_paterno VARCHAR(100) NOT NULL,
    apellido_materno VARCHAR(100) NOT NULL,
...
CREATE TABLE IF NOT EXISTS beneficiario (
    id_beneficiario CHAR(36) NOT NULL PRIMARY KEY,
    id_asegurado CHAR(36) NOT NULL,
...
CREATE TABLE IF NOT EXISTS poliza (
    id_poliza CHAR(36) NOT NULL PRIMARY KEY,
    id_asegurado CHAR(36) NOT NULL,
...
CREATE TABLE IF NOT EXISTS beneficio (
    id_beneficio CHAR(36) NOT NULL PRIMARY KEY,
